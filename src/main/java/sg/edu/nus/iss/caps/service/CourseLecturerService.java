...
public class CourseLecturerService {
    ...
    @Autowired
    public CourseLecturerService(CourseLecturerRepository courseLecturerRepository, CourseRepository courseRepository, LecturerRepository lecturerRepository, CourseStudent courseStudent, StudentRepository studentRepository, CourseStudentRepository courseStudentRepository) {
